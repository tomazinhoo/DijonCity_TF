...
public class AddTripActivity extends AppCompatActivity {
    ...
    private String TAG = AddTripActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DbTripHelper dbTrip = new DbTripHelper(AddTripActivity.this);
                dbTrip.open();
    ...
    private void getPoisAsync() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                final PoiSpinAdapter cinemasAdapter = new PoiSpinAdapter(AddTripActivity.this, android.R.layout.simple_spinner_item, cinemas);
                spinnerCinemas.setAdapter(cinemasAdapter);

                final PoiSpinAdapter restaurantsAdapter = new PoiSpinAdapter(AddTripActivity.this, android.R.layout.simple_spinner_item, restaurants);
